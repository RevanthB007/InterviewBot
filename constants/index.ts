...
export const generator = 
{
    ...
    "nodes": [
      ...
      {
        "name": "conversation_1748624019657",
        "type": "conversation",
        "metadata": {
          "position": {
            "x": -441.7167406197404,
            "y": 114.77289394583309
          }
        },
      ...
      },
      {
        ...
        "metadata": {
          "position": {
            "x": -441.71674061974045,
            "y": 333.38642821373514,
          },
        },
        "tool": {
          "url": 'https://interview-8gutekv8v-revanthb007s-projects.vercel.app/api/vapi/generate',
          "body": {
            "type": "object",
            "properties": {
              "role": {
      ...
      {
        "name": "conversation_1748624648369",
        "type": "conversation",
        "metadata": {
          "position": {
            "x": -441.7167406197404,
    ...
    "edges": [
      ...
      {
        "from": "conversation_1748624648369",
        "to": "hangup_1748624835241",
        "condition": {
          "type": "ai",
          "prompt": ""
        }
      ...
      {
        "from": "conversation_1748624019657",
        "to": "API Request",
        "condition": {
          "type": "ai",
          "prompt": ""
